...
import com.italianswapp.yourtraining3.Timer.CountDownTimers.CountDownActivity;
...
public class CircuitActivity extends CountDownActivity {
    ...
    private static final String CIRCUIT_TYPE = "circuitType";
    ...
    public static Intent getInstance(Context context, ArrayList<Exercise> exercises, WorkoutSaved.WorkoutType workoutType) {
        Intent intent = new Intent(context, CircuitActivity.class);
        intent.putExtra(CIRCUIT_KEY, exercises);
        intent.putExtra(CIRCUIT_TYPE, workoutType.name());
